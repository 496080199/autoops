...
class Application(Application):
    def __init__(self):
        handlers=[
                  ...
                  url(r"/env/([0-9]+)/([0-9]+)",EnvHandler,name='env'),
                  ...
                  url(r"/class",ClassHandler,name='class'),
                  url(r"/newclass",NewclassHandler,name='newclass'),
                  url(r"/editclass",EditclassHandler,name='editclass'),
                  url(r"/delclass/([0-9]+)",DelclassHandler,name='delclass'),
                  url(r"/setclass/([0-9]+)/([0-9]+)",SetclassHandler,name='setclass'),
                  ...
                  url(r"/viewcronlog/([0-9]+)/([0-9]+)/(w+)",ViewcronlogHandler,name='viewcronlog'),
        ]
        settings = {
